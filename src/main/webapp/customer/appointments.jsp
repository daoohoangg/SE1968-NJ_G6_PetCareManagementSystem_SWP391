...
<%
    ...
    // ===== Data that may already be set by the servlet =====
    ...
    // ===== Sort services by category.name then serviceName (null-safe) =====
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        el.querySelectorAll('option').forEach(opt => {
            ...
            const match = text.match(/\(([\d.]+)\s*đ\)/); // keep currency suffix as in data
            if (match) {
        ...
        function updateTotal() {
            ...
            totalText.textContent = "Services total: " + total.toFixed(2) + " đ";
        }
...
<div class="page-container">
    ...
    <%
        if ("1".equals(created)) {
    %>
    <div class="alert alert-success"><i class="bi bi-check-circle-fill me-2"></i>The appointment was created successfully.</div>
    <%
