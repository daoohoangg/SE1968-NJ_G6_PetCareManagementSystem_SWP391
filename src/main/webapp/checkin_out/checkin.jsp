            ...
            <table>
                ...
                <c:choose>
                    <c:when test="${empty bookings}">
                        <tr><td colspan="6" class="empty">No pending bookings found.</td></tr>
                    </c:when>
                    <c:otherwise>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="post" action="${pageContext.request.contextPath}/reception/checkin" style="display:inline">
                                        ...
                                        <button type="submit" class="btn-checkin" onclick="return confirm('Confirm check-in for ${b.customerName}?');">
